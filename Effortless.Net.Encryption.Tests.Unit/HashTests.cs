...
public class HashTests
{
    ...
    [TestCase(true, HashType.SHA512,
        "A300C834A06AA8935B27991C2F3D044009AC1952E0B51845DD8AE2178F778C82F012C3A343266C41A493A8D16966C25A4F88E2A8FBEAE6AD8D5F0AA6FE29665A")]
    ...
    public void Create(bool showBytes, HashType hashType, string result)
    {
        ...
        ClassicAssert.AreEqual(result, hash);
        ClassicAssert.IsTrue(Hash.Verify(hashType, data, sharedKey, showBytes, hash));
        ClassicAssert.IsFalse(Hash.Verify(hashType, data, "unknownKey", showBytes, hash));
    }
    ...
    public void CreateHashInLoop(bool allowPunctuation, bool showBytes, string key1, string key2)
    {
        ...
        for (var n = 0; n < 100; n++)
        {
            ...
            ClassicAssert.IsTrue(password.Length == passLen);

            var hash1 = Hash.Create(HashType.MD5, password, key1, showBytes);
            var hash2 = Hash.Create(HashType.MD5, password, key2, showBytes);

            ClassicAssert.IsTrue(Hash.Verify(HashType.MD5, password, key1, showBytes, hash1));
            ClassicAssert.IsTrue(Hash.Verify(HashType.MD5, password, key2, showBytes, hash2));
    ...
    [TestCase(true, HashType.SHA512,
        "2C5F15C7829564C32AF70D9AEE7389BDE5D0544534010C9058D0D7A0CC7DE49656E0674041A0907B80B1B05E18B459B5428AE8EE0F43A680F0922EE3D00E6A14")]
    ...
    public void CreateWithNoKey(bool showBytes, HashType hashType, string result)
    {
        ...
        ClassicAssert.AreEqual(result, hash);
        ClassicAssert.IsTrue(Hash.Verify(hashType, data, string.Empty, showBytes, hash));
        ClassicAssert.IsFalse(Hash.Verify(hashType, data, "unknownKey", showBytes, hash));
    }
    ...
    public void MultiThreaded()
    {
        ...
        Parallel.For(0, 1000, _ =>
        {
            ...
            ClassicAssert.AreEqual(expected, base64);
        });
    }
    ...
    public void MultiThreaded_v2()
    {
        ...
        {
            var base64 = Convert.ToBase64String(SHA512.HashData(bytes));
            ClassicAssert.AreEqual(expected, base64);
        });
    }
}